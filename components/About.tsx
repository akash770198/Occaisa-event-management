      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-18">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl ml-6 md:ml-10">
            ...
            <div className="absolute left-2 md:left-4 -bottom-6 z-20 bg-gradient-to-br from-[#00d0e6] to-[#7b2cbf] text-white p-6 md:p-8 rounded-2xl shadow-xl w-48 md:w-56 flex flex-col justify-center">
              <span className="text-4xl md:text-5xl font-bold mb-2">{about.yearsExperience}</span>
              <span className="text-base md:text-lg font-semibold leading-tight whitespace-pre-line">
          ...
          <motion.div 
            className="w-full lg:flex-1 flex flex-col pt-16 lg:pt-0"
            initial={{ opacity: 0, x: 40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-100px" }}
