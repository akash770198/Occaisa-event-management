        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="flex flex-col gap-2 mb-6">
              <span className="text-[#a45cf6] font-semibold text-sm md:text-base uppercase tracking-wider">{philosophy.badge}</span>
            ...
            {/* Title */}
            <h2 className="text-4xl lg:text-5xl font-semibold text-[#0b132b] leading-[1.2] mb-8 tracking-tight max-md:text-3xl whitespace-pre-line">
              {philosophy.titleStart}
            </h2>
            ...
            <div className="flex flex-col gap-4">
              {philosophy.features.map((feature: any, index: number) => (
                <div key={index} className="flex gap-4 items-center">
                  <div className="shrink-0 text-[#a45cf6] bg-transparent rounded-full border-none p-0">
                    <CheckCircle2 className="w-5 h-5" strokeWidth={2} />
                  </div>
                  <div>
                    <h4 className="text-base font-semibold text-[#0b132b]">{feature.title}</h4>
                  </div>
                </div>
              ))}
            </div>
