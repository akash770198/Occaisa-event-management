...
import { site, SectionProps, EventsTeamPageData } from "@/data";
...
export default function TeamGrid({ data, className }: SectionProps<EventsTeamPageData> = {}) {
  const { team } = (data || site.teamPage);
